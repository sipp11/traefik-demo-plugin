...
[![Build Status](https://github.com/sipp11/traefik-demo-plugino/workflows/Main/badge.svg?branch=master)](https://github.com/sipp11/traefik-demo-plugino/actions)
...
(In the above example, the `plugindemo` plugin will be loaded from the path `./plugins-local/src/github.com/sipp11/traefik-demo-plugino`.)
